...
public class RanksViewFragment extends Fragment {
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		RanksListItem[] items = new RanksListItem[] {
				...
				new RanksListItem(3, playerScore+"pts",R.drawable.trophy_bronze, playerName, true),
				new RanksListItem(4, "MauerBauer"),
				new RanksListItem(5, "MauerBauer"),
				new RanksListItem(6, "MauerBauer"),
				new RanksListItem(7, "MauerBauer"),
				new RanksListItem(8, "MauerBauer"),
				new RanksListItem(9, "MauerBauer"),
				new RanksListItem(10, "MauerBauer"),
				new RanksListItem(11, "MauerBauer"),
				new RanksListItem(12, "MauerBauer"),
				new RanksListItem(13, "MauerBauer")								
		};
	...
	public void setArguments(Bundle args) {
		...
		playerScore = args.getInt(MainActivity.PLAYERSCORE, -1);
